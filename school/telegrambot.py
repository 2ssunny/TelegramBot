...
def handler(update, context):
    ...
    if user_text == "help" or user_text == "도움" or user_text == "?":
        ...
        context.bot.send_message(
            chat_id=id, text="[대건고등학교 홈페이지](http://daegun.hs.kr)", parse_mode="Markdown"
        )

    elif user_text == "리로스쿨":
        context.bot.send_message(
            chat_id=id,
            text="[대건고등학교 리로스쿨](https://daegun.riroschool.kr/)",
            parse_mode="Markdown",
        )

    elif user_text == "급식":
        context.bot.send_message(
            chat_id=id, text="[대건고등학교 급식](https://url.kr/s98rdn)", parse_mode="Markdown"
        )

    elif user_text == "수행평가":
        context.bot.send_message(
            chat_id=id,
            text="[이번주 수행평가](193.123.237.18/process_judge.html)",
            parse_mode="Markdown",
        )
